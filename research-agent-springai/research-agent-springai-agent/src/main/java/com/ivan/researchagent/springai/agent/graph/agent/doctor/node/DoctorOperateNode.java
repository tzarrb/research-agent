package com.ivan.researchagent.springai.agent.graph.agent.doctor.node;
 ...
 **/
@Slf4j
public class DoctorOperateNode implements NodeAction {

    private ChatService chatService;
    private DoctorTools doctorTools;

    public DoctorOperateNode(ChatService chatService, DoctorTools doctorTools) {
